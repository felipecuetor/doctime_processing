...
cont = 2200
while(cont<8000):
    all_urls.append("https://doaj.org/search?source=%7B%22query%22%3A%7B%22filtered%22%3A%7B%22filter%22%3A%7B%22bool%22%3A%7B%22must%22%3A%5B%7B%22term%22%3A%7B%22index.classification.exact%22%3A%22Social%20sciences%20(General)%22%7D%7D%5D%7D%7D%2C%22query%22%3A%7B%22query_string%22%3A%7B%22query%22%3A%22Colombia%22%2C%22default_field%22%3A%22index.country%22%2C%22default_operator%22%3A%22AND%22%7D%7D%7D%7D%2C%22from%22%3A"+str(cont)+"%2C%22size%22%3A200%7D")
    cont+=200
for url in all_urls:
    driver.get(url)
    time.sleep(7)
